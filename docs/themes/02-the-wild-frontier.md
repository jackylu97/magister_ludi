# 02 · The Wild Frontier
The steppe as a harvest: camps found, cleared, tamed. **Ruled Æra I–II only**; its heir is
The Steppes (15), and Wolf-Mother's tamed horde is the bridge.

## Æra I
- Tech: — (the wild needs none)
- Orders:
  - Camp Followers — Clearing a barbarian camp grants +25 food and a random military unit.
  - Border Ballads — +2 culture for each barbarian camp you have found, and +4 culture for each barbarian unit you kill.
  - Spoils of the Wild — Clearing a barbarian camp pays +100%. Adds to Camp Followers.
...
## Gaps
Deliberately none to fill past II — resist the urge.
