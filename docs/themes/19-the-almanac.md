# 19 · The Almanac
Time itself: omens, calendars, rhythms. The loop: **scheduled triggers** — effects that
fire every N turns — plus foresight and timing races. No other theme's cards care
...
## Æra II
- Tech: The Long Count — unlocks The Long Count, Plantation
- Orders:
...
- Doctrines:
  - ▢ ________
- Deeds:
  - ▢ a timing race — first to research an age's first tech within N turns of the age opening?
...
- **The dice, homed** *(proposal)*: the Magister's Dice become this theme's system — omen
  rites re-roll a die; a die may be SPENT to declare **The Final Omen**: bet, 15+ turns
  out, the turn the age will close (±3). Hitting it pays a bead. The game's one gambling
  verb, given to the theme about foresight.
- Deeds:
  - The Final Omen *(proposal — the bet above)*.

## Gaps
Almost everything is proposal — this is the newest candidate; but its scaler (Drums of
the Seasons) and its bet (The Final Omen) are the two most *mechanically novel* cards in
any sheet, and the dice finally get their sink.
