# 01 · The Imperium
Soldiers are an economy. Cheap, expendable units pay by being built, dying and killing.
Wins by: The Fallen Palace · The Strongest Arm · The Muster of the Realm.
Constraint: war's happiness relief (seized luxuries, held capitals) lives in the Orders here.
...
- Orders:
  ...
  - The Widow's Levy — When a unit of yours dies, its nearest city gains +10 production and you gain +40 gold.
...
- Religion:
  ...
  - Blessing of Arms — augur rite — +True healFully
- Great people: — (generals begin in II)
- Wonders:
  - The Walls of Uruk — your capital: +10 city defence · +2 combat strength inside your capital’s borders · +2 authority capacity
- Deeds:
  - The First General — The first general called into the world.

## Æra II
- Tech:
  - Bronze Panoply — unlocks Phalanx, Barracks
  - Epic Poetry — unlocks Hall of Deeds, Amphitheater, The Theatre of Dionysus, Epic Poetry · losing a unit grants +4 culture
- Orders:
  - Drums of War — Units created from now on are born with +1 combat strength, and keep it for life.
  - The Muster Roll — Units created from now on are born with +10 maximum health, and keep it for life.
  - Field Surgeons — All units heal +10 more per turn, anywhere.
  - March Discipline — Military units gain +1 movement.
  - The Shield Wall — +3 combat strength on hills.
...
- Religion:
  - Rites of Blood — Killing a unit pays +15 faith, once for each age you have reached.
...
posture's whole relief budget and does not exist yet.
