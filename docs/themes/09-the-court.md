...
- Great people: the Æra III rosters
- Deeds:
  - The Dynasty — Call six great people during one age.
  - The Patron — Plant three great works so that each one touches the other two.
  - The Laureate's Court — Plant a great work of every family inside one city's ground.
...
## Gaps
One Order total; both III doctrines deferred; the family tags dissolve into the other
themes at the retag (each family = 2–3 themes' face cards).
