# The bot's priority system — the measurement log

Moved out of `docs/bot-priorities.md` on 2026-09-11. The spec of record stays
there; this is the batch-by-batch measurement narrative (2026-09-04 →
2026-09-10) — every arena A/B, seed sweep, before/after profile and known gap
behind the rules that doc states. Open it for the *why* behind a figure.
