...
**Existing (from the shipped tree):**
- Bronzeworking — spearman · barracks · reveals iron *(the Bronze Age itself)*
- Stonecraft — quarry · monument (+2🎵 +1 authority)
- Calendar — plantation · +1🪙 renewal
- The Wheel — war chariot + chariot archer · granary renewal *(the Iliad's weapon)*
- Letters — library/Tablet House *(oracle-bone writing)*
