...
|---|---|---|
| The Hermit Crown | 🌱 | while you hold ≤3 cities: capital +30% all yields |
| River Kings | 🌱 | +30% 🌾 in freshwater cities · −10% 🌾 and ⚙ in cities without freshwater |
...
| Doctrine | Line | Effect |
|---|---|---|
| The Academy of Deeds | 🏛 | every Triumph grants a second helping of renown · Triumphs you missed by one age can still be earned in the next (the register keeps `(id, age)`) |
| The Standing Army | 🎖 | units cost no upkeep · every 5 units you hold grant +1 authority capacity · −10% 🎵 |
...
| Cuius Regio | 🕯 | cities that share your majority belief… → your rites cost no charge every 3rd use · augurs +1 charge |
| The Yeomanry | 🌱 | every farm +1⚙ · cities of 10+ population −1 happiness |
| Absolutism | — | +6 authority capacity · Orders seal for 10 turns instead of 5 · you may hold one more Order of any kind |
...
| The Philosopher's Stone | 🜍 | the Great Work costs −25% · every Distillery mints +5💰 |
| The Grand Tour (II) | 🏛 | +1🎵 per wonder in the world, seen or not · wonders you hold +3 renown per turn |
| Mare Nostrum | ⚓ | every sea tile you own +1💰 +1🌾 · coastal cities cost no authority |
| The Levée en Masse | 🎖 | when an enemy unit enters your borders, every city with a Barracks musters a militia unit (once per 10 turns) |
| Pax Magistri | 🌱 | +3 happiness per city · every city of 12+ population +5🔬 +5🎵 · you can no longer declare… |
| The Encyclopaedia | ✶ | +1🔬 per building in every city · science buildings cost −50% |
...
| Order | Slot | Line | Tier | Effect |
|---|---|---|---|---|
| Field Surgeons | M | ⚒ |  | units heal +5 per turn anywhere |
...
| Foreign Quarters | E | 🐫 |  | +1💰 and +1🔬 in cities adjacent to another civilization's territory |
| Ore Tithes | E | ⚒ |  | +3⚙ in each city holding an improved strategic resource |
| Terraced Hillsides | E | 🌱 |  | +1🌾 per worked hill tile in each city (cap +4) |
...
| Pilgrim Roads | W | 🕯 |  | +2🕯 per city · +1 happiness per 20 banked 🕯 (max +3) |
...
| Garrison State | M | ⚒ |  | each city +2⚙ per garrisoned combat unit (cap +4/city) |
| Skirmishers' Creed | M | ⚒ |  | ranged units +1 range |
| The Finisher's Art | M | — |  | +5 combat against units below half strength |
| Frontier Forts | M | — |  | +6 defense in cities within 3 hexes of a foreign border |
| Triumphs | M | ⚒ |  | capturing a city grants +30🎵 |
| Client Kings | E | — |  | +4 authority capacity · captured cities cost 2 |
| Provincial Mints | E | 🐫 |  | +1💰 per improved luxury copy — duplicates count |
| Quarrymen's Guild | E | ⚒ |  | +3⚙ in cities holding stone or marble |
| The Grain Dole | E | 🌱 |  | cities of 6+ population: +2 happiness each |
| Mandate of Heaven | W | 🕯 |  | happiness tiers +5pp · +1 authority capacity per 25 banked 🕯 (max +4) |
| The Lyceum | W | ✶ |  | completing a technology grants +15🎵 |
| Census of Souls | W | 🕯 |  | +1🕯 per 2 population in your capital |
| Toleration Edicts | W | — |  | happiness demand −15% |
| The Standing Levy | M | — |  | every city may complete one unit per turn from its basket even if the queue holds a building first (units jump the queue when affordable) |
...
| Levies | M | 🎖 | ● | every city with a Barracks musters a free melee unit every 10 turns · −1 happiness per Barracks |
| Field Hospitals | M | 🎖 | ◆ | units inside your borders heal to full each turn they do not move |
...
| The Synod | W | 🕯 | ◆ | rites last 25% longer · +1🕯 per temple |
...
| The Standing Levy (II) | M | 🎖 | ◆ | units jump the queue when affordable |
| Forced March | M | 🎖 | ○ | combat units +1 movement outside your borders · −5 combat on the turn they moved 3+ hexes |
| The Siege Train | M | ⚒ | ◆ | siege units +1 movement · +10 combat vs cities for units adjacent to a siege unit |
...
| The Salon | E | 🏛 | ● | every great-person draft shows one more card · great people cost +20% renown (the ladder steepens) |
| Cathedral Chapters | E | 🕯 | ◆ | +1 happiness per Cathedral · Cathedrals +2🎵 |
...
| Guild Charters | E | ⚒ | ○ | each Workshop / Forge grants +1 renown per turn to the Engineer family · +5% ⚙ per Workshop in that city (max +15%) |
| Scholastics | W | ✶ | ◆ | +2🔬 per University · completing a technology grants +10🕯 |
| The Inquisition | W | 🕯 | ● | cities with a Temple: +3 happiness and +2🕯 · cities without one: −2 happiness |
| Pilgrimage | W | 🕯 | ○ | +1🎵 per wonder you hold · +1🕯 per Triumph earned |

### Æra V pool

| Order | Slot | Line | Tier | Effect |
|---|---|---|---|---|
| The Corps | M | 🎖 | ● | two units of one type on one hex merge into a corps (+50% strength, one piece) · corps cost 2 authority |
| Bombardiers | M | 🎖 | ◆ | siege units +1 range · Bombards cost −25% ⚙ |
| The Aerostat Corps | M | ✶ | ○ | Aerostats +2 sight · every city with an Observatory +1 sight |
| Rocket Arrows | M | 🜍 | ○ | ranged units +10 combat vs units on open ground · −5 on hills |
| The Adepts | E | 🜍 | ◆ | the Distillery +3🔬 +1🕯 · +1 renown per turn to the Scholar family per Distillery |
| The Furnace | E | 🜍 | ● | every strategic resource counts as one more copy · Forges +2⚙ · −1 happiness per Forge |
| The Porcelain Trade | E | ⚓ | ○ | the Porcelain Works' luxury counts twice · +3💰 per Porcelain Works |
| The Clerks of the Engine | E | 🜍 | ◆ | the Engine +4🔬 · +1🔬 per 2 population in its city |
| Manufactories | E | ⚒ | ◆ | +2⚙ per Manufactory (the great work) in your empire · Manufactories +1💰 |
| The Entranced Workforce (II) | E | 🜍 | ○ | the Entranced Workforce project pays double · −3 happiness while it runs |
| The Grand Tour | W | 🏛 | ◆ | +1🎵 per wonder in the world *you have seen* · +2 renown per turn to the Artist family |
...
| The Magister's Court | W | 🏛 | ○ | great people arrive with a second charge · the Magnum Opus +10% ⚙ |
