...
export const BUILDING_ROW_SILENT: Readonly<Record<string, string>> = {
  ...
  unlockedByLeader: 'availability again, one table over — the figure’s own sheet names it, asked by `isUnlocked` before the fold',
  ...
  requiresSite: 'a refusal rather than a worth — `siteRefusal` prints the simulation’s own sentence for the sited rows',
