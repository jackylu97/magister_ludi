...
export const SHELF_INTROS: Partial<Record<CompendiumSectionId, CompendiumEntry>> = {
  ...
  bead: lead('bead', 'About the Bead Race', '◉', [
    'The Bead Race is the only way to win. There are no separate paths — no conquest track, no science track — just one row of glass beads per player, on the Abacus, where everyone can see them. Whoever fills their rod first wins; if nobody does, the player with the most beads when the last age closes wins instead.',
